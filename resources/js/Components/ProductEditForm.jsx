...
const ProductEditForm = ({ closeForm, editValue }) => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log("tessstt", formData);
        router.post(`product/${editValue.id}`, formData, {
            onSuccess: () => {
                            ...
                            >
                                <div className="mx-3 mb-6">
                                    ...
                                    <div className="px-5">
                                        ...
                                        <button
                                            type="submit"
                                            className="font-bold mt-5 w-full bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 focus:outline-none focus:shadow-outline-blue active:bg-blue-800"
                                        >
                                            Edit
                                        </button>
                                    </div>
